    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processing_step', models.CharField(blank=True, choices=[('ingested', 'Ingested'), ('standardized', 'Standardized'), ('formatted', 'Formatted'), ('queued', 'Queued'), ('sent', 'Sent')], help_text='Last processing step that handled this message', max_length=20, null=True)),
                ('step_processing_time', models.JSONField(default=dict, help_text='Time spent in each processing step (in seconds)')),
